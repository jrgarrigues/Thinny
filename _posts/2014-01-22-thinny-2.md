...
> Do you like it? You can [download Thinny from GitHub](https://github.com/camporez/Thinny/releases).

-----
Is there something else you want to see added? [Open an issue](https://github.com/camporez/camporez.github.io/issues/new).
